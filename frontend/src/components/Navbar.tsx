    ...
    <>
      ...
      >
        ...
        <nav className="hidden md:flex items-center gap-6 lg:gap-8 text-orange-500 text-sm font-medium">
          ...
          <a
            className="hover:text-orange-600 flex items-center gap-2 transition-colors font-bold text-orange-600"
            href="/tech-demo"
            title="Java & PHP Demo"
          >
            <svg
      ...
      <>
        ...
        >
          <nav className="flex flex-col gap-1">
            ...
            <a
              className="flex items-center gap-2.5 px-3 py-2 text-orange-600 font-bold text-sm rounded-lg hover:bg-orange-50 hover:text-orange-700 transition-all bg-orange-50"
              href="/tech-demo"
              onClick={closeMenu}
            >
              <svg
